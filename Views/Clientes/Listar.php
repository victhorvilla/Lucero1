            ...
            <form method="post" action="<?php echo base_url(); ?>Clientes/insertar" autocomplete="off">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input id="ruc" class="form-control" type="text" name="ruc" required minlength="11" maxlength="11"  pattern="[1-2]{1}0[0-9]{9}" placeholder="Ruc">                       
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="direccion" class="form-control" type="text" name="direccion" required minlength="5" maxlength="50"  pattern="[A-Z,0-9, ,°,/]{5,50}" placeholder="Dirección">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="telefono" class="form-control" type="text" name="telefono" required minlength="9" maxlength="9"  pattern="9{1}[0-9]{8}" placeholder="Teléfono">
